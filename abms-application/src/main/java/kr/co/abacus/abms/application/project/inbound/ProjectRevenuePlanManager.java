...
public interface ProjectRevenuePlanManager {
    ...
    ProjectRevenuePlan create(CurrentActor actor, ProjectRevenuePlanCreateRequest request);

    ProjectRevenuePlan update(Long projectId, Integer sequence, ProjectRevenuePlanUpdateRequest request);

    ProjectRevenuePlan update(CurrentActor actor, Long projectId, Integer sequence, ProjectRevenuePlanUpdateRequest request);

    ProjectRevenuePlan issue(Long projectId, Integer sequence);

    ProjectRevenuePlan issue(CurrentActor actor, Long projectId, Integer sequence);

    ProjectRevenuePlan cancel(Long projectId, Integer sequence);

    ProjectRevenuePlan cancel(CurrentActor actor, Long projectId, Integer sequence);
