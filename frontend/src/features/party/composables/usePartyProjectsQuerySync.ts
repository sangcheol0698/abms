...
const QUERY_KEYS = {
  page: 'partyProjectPage',
  size: 'partyProjectSize',
  name: 'partyProjectName',
  statuses: 'partyProjectStatuses',
} as const;

export interface UsePartyProjectsQuerySyncOptions {
  page: Ref<number>;
  pageSize: Ref<number>;
  columnFilters: Ref<ColumnFiltersState>;
}

export function usePartyProjectsQuerySync(options: UsePartyProjectsQuerySyncOptions) {
