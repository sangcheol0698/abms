<template>
  <div class="flex items-start gap-3" :class="message.role === 'user' ? 'flex-row-reverse text-right' : ''">
    <div class="flex h-9 w-9 items-center justify-center rounded-full border text-sm font-semibold"
    ...
    <div class="max-w-[85%] space-y-1 text-sm">
      ...
      <div v-if="message.role === 'user'" class="whitespace-pre-line rounded-2xl border px-4 py-3 shadow-sm"
