...
public class HexagonalArchitectureTest {
    ...
    @ArchTest
    ArchRule applicationMustNotDependOnAdapter = noClasses()
            .that().resideInAPackage("kr.co.abacus.abms.application..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("kr.co.abacus.abms.adapter..");

    @ArchTest
    ArchRule domainMustNotDependOnUpperLayers = noClasses()
            .that().resideInAPackage("kr.co.abacus.abms.domain..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("kr.co.abacus.abms.application..", "kr.co.abacus.abms.adapter..");
