...
INSERT INTO tb_notification (
    ...
    (1, 1, '조직 구조 변경', '부서 목록에서 경영기획실이 신설되었습니다.', 'INFO', 0, '/', NOW(), NOW(), 'ABMS_INIT', 'ABMS_INIT', 0),
...
INSERT INTO abms.tb_employee_monthly_cost (deleted,monthly_salary,overhead_cost,sga_cost,total_cost,cost_month,created_at,deleted_at,employee_id,updated_at,created_by,deleted_by,updated_by) VALUES
	 (0,25000000.00,2500000.00,1250000.00,28750000.00,'202602',NOW(),NULL,1,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,20833333.00,2083333.00,1041667.00,23958333.00,'202602',NOW(),NULL,2,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,16666667.00,1666667.00,833333.00,19166667.00,'202602',NOW(),NULL,3,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,16666667.00,1666667.00,833333.00,19166667.00,'202602',NOW(),NULL,4,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,13333333.00,1333333.00,666667.00,15333333.00,'202602',NOW(),NULL,5,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,11666667.00,1166667.00,583333.00,13416667.00,'202602',NOW(),NULL,6,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,10833333.00,1083333.00,541667.00,12458333.00,'202602',NOW(),NULL,7,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,10833333.00,1083333.00,541667.00,12458333.00,'202602',NOW(),NULL,8,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,13333333.00,1333333.00,666667.00,15333333.00,'202602',NOW(),NULL,9,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8750000.00,875000.00,437500.00,10062500.00,'202602',NOW(),NULL,10,NOW(),'ABMS_INIT',NULL,'ABMS_INIT');
INSERT INTO abms.tb_employee_monthly_cost (deleted,monthly_salary,overhead_cost,sga_cost,total_cost,cost_month,created_at,deleted_at,employee_id,updated_at,created_by,deleted_by,updated_by) VALUES
	 (0,8500000.00,850000.00,425000.00,9775000.00,'202602',NOW(),NULL,11,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8166667.00,816667.00,408333.00,9391667.00,'202602',NOW(),NULL,12,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8250000.00,825000.00,412500.00,9487500.00,'202602',NOW(),NULL,13,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8083333.00,808333.00,404167.00,9295833.00,'202602',NOW(),NULL,14,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8416667.00,841667.00,420833.00,9679167.00,'202602',NOW(),NULL,15,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8000000.00,800000.00,400000.00,9200000.00,'202602',NOW(),NULL,16,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8000000.00,800000.00,400000.00,9200000.00,'202602',NOW(),NULL,17,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8208333.00,820833.00,410417.00,9439583.00,'202602',NOW(),NULL,18,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,8000000.00,800000.00,400000.00,9200000.00,'202602',NOW(),NULL,19,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,6500000.00,650000.00,325000.00,7475000.00,'202602',NOW(),NULL,20,NOW(),'ABMS_INIT',NULL,'ABMS_INIT');
INSERT INTO abms.tb_employee_monthly_cost (deleted,monthly_salary,overhead_cost,sga_cost,total_cost,cost_month,created_at,deleted_at,employee_id,updated_at,created_by,deleted_by,updated_by) VALUES
	 (0,6333333.00,633333.00,316667.00,7283333.00,'202602',NOW(),NULL,21,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,6666667.00,666667.00,333333.00,7666667.00,'202602',NOW(),NULL,22,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,6583333.00,658333.00,329167.00,7570833.00,'202602',NOW(),NULL,23,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,6250000.00,625000.00,312500.00,7187500.00,'202602',NOW(),NULL,24,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,6166667.00,616667.00,308333.00,7091667.00,'202602',NOW(),NULL,25,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,6083333.00,608333.00,304167.00,6995833.00,'202602',NOW(),NULL,26,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,6000000.00,600000.00,300000.00,6900000.00,'202602',NOW(),NULL,27,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3500000.00,350000.00,175000.00,4025000.00,'202602',NOW(),NULL,28,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,4833333.00,483333.00,241667.00,5558333.00,'202602',NOW(),NULL,29,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,4666667.00,466667.00,233333.00,5366667.00,'202602',NOW(),NULL,30,NOW(),'ABMS_INIT',NULL,'ABMS_INIT');
INSERT INTO abms.tb_employee_monthly_cost (deleted,monthly_salary,overhead_cost,sga_cost,total_cost,cost_month,created_at,deleted_at,employee_id,updated_at,created_by,deleted_by,updated_by) VALUES
	 (0,4583333.00,458333.00,229167.00,5270833.00,'202602',NOW(),NULL,31,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,4750000.00,475000.00,237500.00,5462500.00,'202602',NOW(),NULL,32,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,4916667.00,491667.00,245833.00,5654167.00,'202602',NOW(),NULL,33,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,4500000.00,450000.00,225000.00,5175000.00,'202602',NOW(),NULL,34,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,5000000.00,500000.00,250000.00,5750000.00,'202602',NOW(),NULL,35,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,4833333.00,483333.00,241667.00,5558333.00,'202602',NOW(),NULL,36,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,4958333.00,495833.00,247917.00,5702083.00,'202602',NOW(),NULL,37,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3333333.00,333333.00,166667.00,3833333.00,'202602',NOW(),NULL,38,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3166667.00,316667.00,158333.00,3641667.00,'202602',NOW(),NULL,39,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3250000.00,325000.00,162500.00,3737500.00,'202602',NOW(),NULL,40,NOW(),'ABMS_INIT',NULL,'ABMS_INIT');
INSERT INTO abms.tb_employee_monthly_cost (deleted,monthly_salary,overhead_cost,sga_cost,total_cost,cost_month,created_at,deleted_at,employee_id,updated_at,created_by,deleted_by,updated_by) VALUES
	 (0,3166667.00,316667.00,158333.00,3641667.00,'202602',NOW(),NULL,41,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3416667.00,341667.00,170833.00,3929167.00,'202602',NOW(),NULL,42,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3333333.00,333333.00,166667.00,3833333.00,'202602',NOW(),NULL,43,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3333333.00,333333.00,166667.00,3833333.00,'202602',NOW(),NULL,44,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3583333.00,358333.00,179167.00,4120833.00,'202602',NOW(),NULL,45,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3666667.00,366667.00,183333.00,4216667.00,'202602',NOW(),NULL,46,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3750000.00,375000.00,187500.00,4312500.00,'202602',NOW(),NULL,47,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,3416667.00,341667.00,170833.00,3929167.00,'202602',NOW(),NULL,48,NOW(),'ABMS_INIT',NULL,'ABMS_INIT'),
	 (0,4000000.00,400000.00,200000.00,4600000.00,'202602',NOW(),NULL,49,NOW(),'ABMS_INIT',NULL,'ABMS_INIT');
