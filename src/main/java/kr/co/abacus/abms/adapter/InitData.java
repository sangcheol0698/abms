...
public class InitData {
    ...
    public void init() {
        ...
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            ...
            EmployeePosition.PRESIDENT, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, "대표이사"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            company.getId(), "vp@abms.co", "김부사장", LocalDate.of(2017, 7, 1), LocalDate.of(1973, 9, 3),
            EmployeePosition.VICE_PRESIDENT, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, "경영총괄"
        )));
        ...
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            ...
            EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, "재무팀장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            finTeam.getId(), "fin1@abms.co", "이지은", LocalDate.of(2020, 9, 14), LocalDate.of(1992, 1, 28),
            EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, "결산/세무"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            finTeam.getId(), "fin2@abms.co", "정우성", LocalDate.of(2022, 5, 2), LocalDate.of(1996, 6, 9),
            EmployeePosition.ASSOCIATE, EmployeeType.OUTSOURCING, EmployeeGrade.JUNIOR, "외주 지원"
        )));

        // 기술본부 - 플랫폼개발담당: 백엔드팀
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            beTeam.getId(), "be.lead@abms.co", "홍백엔", LocalDate.of(2018, 4, 2), LocalDate.of(1988, 4, 30),
            EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, "백엔드팀장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            beTeam.getId(), "be1@abms.co", "김백엔", LocalDate.of(2021, 3, 8), LocalDate.of(1993, 10, 5),
            EmployeePosition.LEADER, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, "마이크로서비스/아키텍처"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            beTeam.getId(), "be2@abms.co", "이도윤", LocalDate.of(2022, 7, 4), LocalDate.of(1995, 2, 17),
            EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, "도메인/영속성"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            beTeam.getId(), "be3@abms.co", "박지훈", LocalDate.of(2024, 1, 2), LocalDate.of(1999, 3, 9),
            EmployeePosition.ASSOCIATE, EmployeeType.FREELANCER, EmployeeGrade.JUNIOR, "배치/ETL"
        )));

        // 기술본부 - 플랫폼개발담당: 프론트엔드팀
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            feTeam.getId(), "fe.lead@abms.co", "이프론", LocalDate.of(2019, 8, 19), LocalDate.of(1989, 7, 21),
            EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, "프론트엔드팀장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            feTeam.getId(), "fe1@abms.co", "최유진", LocalDate.of(2021, 11, 1), LocalDate.of(1994, 5, 6),
            EmployeePosition.LEADER, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, "Vue/Tailwind"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            feTeam.getId(), "fe2@abms.co", "강서현", LocalDate.of(2023, 3, 6), LocalDate.of(1998, 12, 1),
            EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, "CSR/SSR"
        )));

        // 기술본부 - 데이터담당: 데이터엔지니어링팀
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            deTeam.getId(), "de.lead@abms.co", "유데엔", LocalDate.of(2017, 5, 22), LocalDate.of(1987, 9, 14),
            EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, "데이터팀장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            deTeam.getId(), "de1@abms.co", "이현우", LocalDate.of(2020, 10, 12), LocalDate.of(1993, 1, 20),
            EmployeePosition.STAFF, EmployeeType.OUTSOURCING, EmployeeGrade.MID_LEVEL, "파이프라인/모델서빙"
        )));

        // 기술연구소 - AI팀
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            aiTeam.getId(), "ai.lead@abms.co", "오에이", LocalDate.of(2019, 1, 14), LocalDate.of(1990, 2, 1),
            EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, "AI팀장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            aiTeam.getId(), "ai1@abms.co", "김가람", LocalDate.of(2022, 2, 7), LocalDate.of(1996, 4, 11),
            EmployeePosition.LEADER, EmployeeType.FREELANCER, EmployeeGrade.EXPERT, "LLM/프롬프트"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            aiTeam.getId(), "ai2@abms.co", "박하늘", LocalDate.of(2023, 9, 4), LocalDate.of(1998, 7, 19),
            EmployeePosition.ASSOCIATE, EmployeeType.PART_TIME, EmployeeGrade.JUNIOR, "리서치 보조"
        )));

        // 영업본부 - 국내영업팀
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            krSalesTeam.getId(), "sales.kr.mgr@abms.co", "민영국", LocalDate.of(2018, 9, 3), LocalDate.of(1986, 11, 23),
            EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, "국내영업팀장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            krSalesTeam.getId(), "sales.kr1@abms.co", "서지호", LocalDate.of(2021, 6, 7), LocalDate.of(1994, 9, 2),
            EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, "영업/견적"
        )));

        // 영업본부 - 해외영업팀
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            globalSalesTeam.getId(), "sales.gl.mgr@abms.co", "노해외", LocalDate.of(2017, 4, 10), LocalDate.of(1985, 8, 7),
            EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, "해외영업팀장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            globalSalesTeam.getId(), "sales.gl1@abms.co", "장예린", LocalDate.of(2022, 1, 3), LocalDate.of(1996, 10, 10),
            EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, "수출/파트너"
        )));

        // 영업본부 - 사업기획TF
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            bizTf.getId(), "biztf.lead@abms.co", "문기획", LocalDate.of(2020, 12, 1), LocalDate.of(1989, 1, 9),
            EmployeePosition.LEADER, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, "TF 리더"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            bizTf.getId(), "biztf1@abms.co", "배수아", LocalDate.of(2023, 4, 3), LocalDate.of(1997, 12, 25),
            EmployeePosition.ASSOCIATE, EmployeeType.OUTSOURCING, EmployeeGrade.JUNIOR, "시장/경쟁 분석"
        )));

        // 임원 (본부 소속)
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            mgmtDivision.getId(), "dir.mgmt@abms.co", "박이사", LocalDate.of(2016, 2, 1), LocalDate.of(1978, 6, 18),
            EmployeePosition.DIRECTOR, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, "경영관리본부장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            techDivision.getId(), "md.tech@abms.co", "정상무", LocalDate.of(2016, 9, 1), LocalDate.of(1976, 3, 12),
            EmployeePosition.MANAGING_DIRECTOR, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, "기술본부장"
        )));
        employeeRepository.save(Employee.create(new EmployeeCreateRequest(
            salesDivision.getId(), "dir.sales@abms.co", "이영업", LocalDate.of(2017, 1, 2), LocalDate.of(1979, 10, 4),
            EmployeePosition.DIRECTOR, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, "영업본부장"
        )));
    }
