...
public class InitData {
    ...
    public void init() {
        ...
        employeeRepository.save(Employee.create(employee(
                ...
                EmployeePosition.PRESIDENT, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, EmployeeAvatar.SKY_GLOW,
                "대표이사")));
        employeeRepository.save(Employee.create(employee(
        ...
        employeeRepository.save(Employee.create(employee(
                ...
                EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, EmployeeAvatar.CORAL_SPARK,
                "인사팀장")));
        employeeRepository.save(Employee.create(employee(
                hrTeam.getId(), "hr1@abms.co", "박서연", LocalDate.of(2021, 4, 5), LocalDate.of(1994, 11, 13),
                EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, EmployeeAvatar.FOREST_MINT,
                "채용/평가")));
        employeeRepository.save(Employee.create(employee(
                hrTeam.getId(), "hr2@abms.co", "최민준", LocalDate.of(2023, 1, 9), LocalDate.of(1997, 8, 22),
                EmployeePosition.ASSOCIATE, EmployeeType.PART_TIME, EmployeeGrade.JUNIOR, EmployeeAvatar.LAVENDER_MOON,
                "인턴/보조")));

        // 경영관리본부 재무팀
        employeeRepository.save(Employee.create(employee(
                finTeam.getId(), "fin.mgr@abms.co", "한재무", LocalDate.of(2018, 6, 11), LocalDate.of(1983, 12, 2),
                EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, EmployeeAvatar.COBALT_WAVE,
                "재무팀장")));
        employeeRepository.save(Employee.create(employee(
                finTeam.getId(), "fin1@abms.co", "이지은", LocalDate.of(2020, 9, 14), LocalDate.of(1992, 1, 28),
                EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, EmployeeAvatar.ORANGE_BURST,
                "결산/세무")));
        employeeRepository.save(Employee.create(employee(
                finTeam.getId(), "fin2@abms.co", "정우성", LocalDate.of(2022, 5, 2), LocalDate.of(1996, 6, 9),
                EmployeePosition.ASSOCIATE, EmployeeType.OUTSOURCING, EmployeeGrade.JUNIOR, EmployeeAvatar.SAGE_GUARD,
                "외주 지원")));

        // 기술본부 - 플랫폼개발담당: 백엔드팀
        employeeRepository.save(Employee.create(employee(
                beTeam.getId(), "be.lead@abms.co", "홍백엔", LocalDate.of(2018, 4, 2), LocalDate.of(1988, 4, 30),
                EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, EmployeeAvatar.BLOSSOM_SMILE,
                "백엔드팀장")));
        employeeRepository.save(Employee.create(employee(
                beTeam.getId(), "be1@abms.co", "김백엔", LocalDate.of(2021, 3, 8), LocalDate.of(1993, 10, 5),
                EmployeePosition.LEADER, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, EmployeeAvatar.MIDNIGHT_WINK,
                "마이크로서비스/아키텍처")));
        employeeRepository.save(Employee.create(employee(
                beTeam.getId(), "be2@abms.co", "이도윤", LocalDate.of(2022, 7, 4), LocalDate.of(1995, 2, 17),
                EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, EmployeeAvatar.AQUA_SPLASH,
                "도메인/영속성")));
        employeeRepository.save(Employee.create(employee(
                beTeam.getId(), "be3@abms.co", "박지훈", LocalDate.of(2024, 1, 2), LocalDate.of(1999, 3, 9),
                EmployeePosition.ASSOCIATE, EmployeeType.FREELANCER, EmployeeGrade.JUNIOR, EmployeeAvatar.GOLDEN_RAY,
                "배치/ETL")));

        // 기술본부 - 플랫폼개발담당: 프론트엔드팀
        employeeRepository.save(Employee.create(employee(
                feTeam.getId(), "fe.lead@abms.co", "이프론", LocalDate.of(2019, 8, 19), LocalDate.of(1989, 7, 21),
                EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, EmployeeAvatar.SUNSET_BREEZE,
                "프론트엔드팀장")));
        employeeRepository.save(Employee.create(employee(
                feTeam.getId(), "fe1@abms.co", "최유진", LocalDate.of(2021, 11, 1), LocalDate.of(1994, 5, 6),
                EmployeePosition.LEADER, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, EmployeeAvatar.ORANGE_BURST,
                "Vue/Tailwind")));
        employeeRepository.save(Employee.create(employee(
                feTeam.getId(), "fe2@abms.co", "강서현", LocalDate.of(2023, 3, 6), LocalDate.of(1998, 12, 1),
                EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, EmployeeAvatar.SKY_GLOW,
                "CSR/SSR")));
        ...
        employeeRepository.save(Employee.create(employee(
                ...
                EmployeePosition.STAFF, EmployeeType.OUTSOURCING, EmployeeGrade.MID_LEVEL, EmployeeAvatar.LAVENDER_MOON,
                "파이프라인/모델서빙")));

        // 기술연구소 - AI팀
        employeeRepository.save(Employee.create(employee(
                aiTeam.getId(), "ai.lead@abms.co", "오에이", LocalDate.of(2019, 1, 14), LocalDate.of(1990, 2, 1),
                EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, EmployeeAvatar.MIDNIGHT_WINK,
                "AI팀장")));
        employeeRepository.save(Employee.create(employee(
                aiTeam.getId(), "ai1@abms.co", "김가람", LocalDate.of(2022, 2, 7), LocalDate.of(1996, 4, 11),
                EmployeePosition.LEADER, EmployeeType.FREELANCER, EmployeeGrade.EXPERT, EmployeeAvatar.AQUA_SPLASH,
                "LLM/프롬프트")));
        employeeRepository.save(Employee.create(employee(
                aiTeam.getId(), "ai2@abms.co", "박하늘", LocalDate.of(2023, 9, 4), LocalDate.of(1998, 7, 19),
                EmployeePosition.ASSOCIATE, EmployeeType.PART_TIME, EmployeeGrade.JUNIOR, EmployeeAvatar.SAGE_GUARD,
                "리서치 보조")));
        ...
        employeeRepository.save(Employee.create(employee(
                ...
                EmployeePosition.MANAGER, EmployeeType.FULL_TIME, EmployeeGrade.SENIOR, EmployeeAvatar.GOLDEN_RAY,
                "국내영업팀장")));
        employeeRepository.save(Employee.create(employee(
                krSalesTeam.getId(), "sales.kr1@abms.co", "서지호", LocalDate.of(2021, 6, 7), LocalDate.of(1994, 9, 2),
                EmployeePosition.STAFF, EmployeeType.FULL_TIME, EmployeeGrade.MID_LEVEL, EmployeeAvatar.BLOSSOM_SMILE,
                "영업/견적")));
        ...
        employeeRepository.save(Employee.create(employee(
                ...
                EmployeePosition.LEADER, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, EmployeeAvatar.CORAL_SPARK,
                "TF 리더")));
        employeeRepository.save(Employee.create(employee(
                bizTf.getId(), "biztf1@abms.co", "배수아", LocalDate.of(2023, 4, 3), LocalDate.of(1997, 12, 25),
                EmployeePosition.ASSOCIATE, EmployeeType.OUTSOURCING, EmployeeGrade.JUNIOR, EmployeeAvatar.FOREST_MINT,
                "시장/경쟁 분석")));

        // 임원 (본부 소속)
        employeeRepository.save(Employee.create(employee(
                mgmtDivision.getId(), "dir.mgmt@abms.co", "박이사", LocalDate.of(2016, 2, 1), LocalDate.of(1978, 6, 18),
                EmployeePosition.DIRECTOR, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, EmployeeAvatar.SAGE_GUARD,
                "경영관리본부장")));
        employeeRepository.save(Employee.create(employee(
        ...
        employeeRepository.save(Employee.create(employee(
                ...
                EmployeePosition.DIRECTOR, EmployeeType.FULL_TIME, EmployeeGrade.EXPERT, EmployeeAvatar.GOLDEN_RAY,
                "영업본부장")));
